...
while no_propertylist <= len(propertyType):
    r    = requests.get('https://homes.trovit.my/index.php/cod.search_homes/type.1/what_d.kuala%20lumpur/sug.0/isUserSearch.1/origin.2/order_by.source_date/price_min.100000/rooms_min.1/bathrooms_min.1/area_min.500/property_type.'+propertyType[no_propertylist-1]+'/')
    ...
    while page <= total_page:
            r    = requests.get('https://homes.trovit.my/index.php/cod.search_homes/type.1/what_d.kuala%20lumpur/origin.2/price_min.100000/rooms_min.1/bathrooms_min.1/property_type.'+propertyType[no_propertylist-1]+'/area_min.500/order_by.source_date/resultsPerPage.25/isUserSearch.1/page.'+str(page))
...
dataframe.to_csv('HomeTrovit_raw.csv', index=False)
